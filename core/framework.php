...
class theme_setup
{
    ...
    function _support_widget()
    {
        echo 'Wanneer u gebruik maakt van ons website abonnement kunt u gratis gebruikmaken van onze support dienst.
    <br /><br />
    U kunt ons tijdens onze openingstijden bereiken op het
    telefoonnummer 0523-683044.
    <br /><br />
    Of kijk op onze website: <a href="https://profi-web.nl/support/" target="_blank">www.profi-web.nl</a>.
    <br /><br />
    <b>Hier zijn ook enkele handleidingen te downloaden.</b>';
    }

    function add_support_widget()
    {
        add_action('wp_dashboard_setup', array($this,'_add_support_widget'));
    }
    ...
    function _add_dashboard_footer()
    {
        echo '<span id="footer-note">Website gemaakt door <a href="http://www.profi-web.nl/" target="_blank">Profi-Web</a>.</span>';
    }

    function add_dashboard_footer()
    {
        add_filter('admin_footer_text', array($this, '_add_dashboard_footer'));
    }

    function _add_dashboard_admin_bar($admin_bar)
    {
        $admin_bar->add_menu(array(
            'id' => 'profi-web-need-support',
            'title' => 'Hulp nodig?',
            'href' => 'https://profi-web.nl/support/',
            'meta' => array(
                'title' => 'Neem contact op met Profi-Web',
                'target' => '_blank',
            ),
        ));
    }

    function add_dashboard_admin_bar()
    {
        add_action('admin_bar_menu', array($this, '_add_dashboard_admin_bar'), 999);
    }
...
class customizer
{
    ...
    function customizations($wp_customize)
    {
        ...
        function add_footer($wp_customize)
        {
            ...
            create_control_2($wp_customize, 3, $section, 'footer_copyright', 'Footer copyright', '', '', '');
        }
...
if (class_exists('WP_Customize_Control')) {
    class WP_Customize_Teeny_Control extends WP_Customize_Control {
        ...
        function render_content() {
            ...
            ?>
            <label>
                <label for="_customize-input-header_text" class="customize-control-title"><?php echo esc_html($this->label); ?></label>
